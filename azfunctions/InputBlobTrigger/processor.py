    ...
    def update_latest_forecast(self) -> None:
        ...
        self.db_execute_and_commit(
            ...
            CREATE MATERIALIZED VIEW IF NOT EXISTS {self.tables['latest'][self.hemisphere]} AS
                ...
                GROUP BY date_forecast_generated, date_forecast_for, cell_id, sea_ice_concentration_mean, sea_ice_concentration_stddev, geom_{self.projections[self.hemisphere]}, geom_4326
                WITH NO DATA;
